...
export class QueryService {
  ...
  private generateEvidenceSuggestions(riskPoint: string): string[] {
  ...
  private generatePossibleFindings(riskPoint: string): string[] {
  ...
  private generateRectificationSuggestions(riskPoint: string): string[] {
    const suggestions: Record<string, string[]> = {
