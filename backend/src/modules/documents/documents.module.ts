...
@Module({
  imports: [TypeOrmModule.forFeature([DocumentEntity, DocumentChunkEntity, DocumentExtractionJobEntity]), DatabaseSupportModule, AuthModule, forwardRef(() => GroupsModule), SubscriptionsModule],
