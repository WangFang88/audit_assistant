...
let QueryService = class QueryService {
    ...
    search(dto) {
        ...
        const tokens = ['采购', '资金', '审批', '合同', '验收', '预算', '支付'].filter((token) => lowerQuestion.includes(token));
