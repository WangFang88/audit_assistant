...
exports.DatabaseSupportModule = DatabaseSupportModule = __decorate([
    (0, common_1.Module)({
        providers: [auth_user_repository_1.AuthUserRepository, document_repository_1.DocumentRepository, team_repository_1.TeamRepository],
        exports: [auth_user_repository_1.AuthUserRepository, document_repository_1.DocumentRepository, team_repository_1.TeamRepository],
    })
